...
* `lscpu` (CPU specs and core count)
* `free -h` (System RAM allocations)
* `df -h` (Storage volume capacities and mount points)
* `ip addr show` (Network interface configurations)

## Skills Learned
* Server system auditing via command line interfaces.
* Cloud provider resource mapping across AWS, Azure, and GCP.
* Technical Markdown documentation structuring.
* System architecture planning and diagramming.

## Challenges Encountered
* *Formatting System Specs:* Solved by structuring command outputs systematically into Markdown tables and lists for improved readability.
